...
const BLOCK_NAME = `${PLUGIN_NAME}/leadership` // modifier

registerBlockType(BLOCK_NAME, {
  title: __('gabarit2 block3'),
  description: __('Another example Gabarit 2 / Block 3'),
  icon: 'media-document',
  category: 'common',
  attributes: {
    imageUrl: {
  ...
  edit: props => {
    const { attributes: { imageUrl, imageId, switchDisplay, title, h31, h32, h33, h34, p1, p2, p3, p4, textLink, link }, setAttributes, className } = props
    return (
      <>
  ...
  save: ({ attributes: { imageUrl, title, h31, h32, h33, h34, p1, p2, p3, p4, textLink, link } }) => (
